...
class TransformMatrix extends _Mat{
	...
	constructor(...dt){
		...
		this._t.rotX=function(a,fa,fb,fc){fb=fb||0;fc=fc||0;a=radians(a);return [[1,0,0,0],[0,cos(a),-sin(a),fb*(1-cos(a))+fc*sin(a)],[0,sin(a),cos(a),fc*(1-cos(a))+fb*sin(a)],[0,0,0,1]]}
		this._t.rotY=function(a,fa,fb,fc){fa=fa||0;fc=fc||0;a=radians(a);return [[cos(a),0,-sin(a),fa*(1-cos(a))+fc*sin(a)],[0,1,0,0],[sin(a),0,cos(a),fc*(1-cos(a))+fa*sin(a)],[0,0,0,1]]}
		this._t.rotZ=function(a,fa,fb,fc){fa=fa||0;fb=fb||0;a=radians(a);return [[cos(a),-sin(a),0,fa*(1-cos(a))+fb*sin(a)],[sin(a),cos(a),0,fb*(1-cos(a))+fa*sin(a)],[0,0,1,0],[0,0,0,1]]}
		this.dt=dt.slice()
		this._rc()
	}
	clear(){
